...
I built a Lambda function that retrieves and condenses Security Hub findings, then invokes a Bedrock-hosted large language model to analyze risk and produce a structured report. This reduces manual analysis and makes security findings immediately actionable for stakeholders.
